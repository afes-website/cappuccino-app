...
const iconPaths = {
  ...
  PersonTeacher:
    "M12,12c2.2,0,4-1.8,4-4s-1.8-4-4-4S8,5.8,8,8S9.8,12,12,12zM8.3,14.6L11,20H4v-2C4,16.3,6.1,15.2,8.3,14.6zM20,18v2h-7l2.7-5.4C17.9,15.2,20,16.3,20,18zM11,20v-4h2v4H11zM10.5,14h3L13,15.5h-2L10.5,14z",
  LightMode:
